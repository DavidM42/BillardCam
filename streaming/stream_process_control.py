...
def start_stream_command(streaming_start_command):
    ...
    return subprocess.Popen(streaming_start_command, shell=False, stdin=subprocess.DEVNULL, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, preexec_fn=os.setsid)
